...
describe('checkForUpdate', () => {
  ...
  it('использует HEAD-запрос', async () => {
    ...
    // `no-cache` обязателен: ETag из кэша браузера всегда равен сохранённому,
    // и проверка не увидела бы обновления никогда.
    expect(fetchMock).toHaveBeenCalledWith(url, { method: 'HEAD', cache: 'no-cache' })
  })
