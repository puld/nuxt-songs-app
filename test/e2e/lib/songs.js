...
export const SONGS = {
  ...
  // Пятый куплет — ради «схлопывать повтор корня»: C, C7, C/E (после
  // упрощения баса тоже C), G — три подряд с корнем C схлопываются в один.
  CHORDS_BASS: {
    n: firstWithBass.n,
    title: firstWithBass.title,
    complexOriginal: ['Csus4', 'Ddim', 'Am7(b5)', 'G+'],
    complexSimplified: ['C', 'Dm', 'Am', 'G'],
    repeatedRootOriginal: ['C', 'C7', 'C', 'G'],
    repeatedRootCollapsed: ['C', 'G'],
  },
